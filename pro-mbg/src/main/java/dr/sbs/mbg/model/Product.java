...
public class Product implements Serializable {
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "货号", position = 8)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "删除状态：0->未删除；1->已删除", position = 9)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "上架状态：0->下架；1->上架", position = 10)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "新品状态:0->不是新品；1->新品", position = 11)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "推荐状态；0->不推荐；1->推荐", position = 12)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "审核状态：0->未审核；1->审核通过", position = 13)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "促销价格", position = 17)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "赠送的成长值", position = 18)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "赠送的积分", position = 19)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "限制使用的积分数", position = 20)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "副标题", position = 21)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "促销开始时间", position = 33)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "促销结束时间", position = 34)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "活动限购数量", position = 35)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "促销类型：0->没有促销使用原价;1->使用促销价；2->使用会员价；3->使用阶梯价格；4->使用满减价格；5->限时购", position = 36)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "品牌名称", position = 37)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "商品分类名称", position = 38)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "商品描述", position = 39)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "产品详情网页内容", position = 41)
     ...
     * @mbg.generated
     */
    @ApiModelProperty(value = "移动端网页详情", position = 42)
