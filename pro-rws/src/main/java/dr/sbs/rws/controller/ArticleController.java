...
import dr.sbs.rws.service.ArticleService;
...
public class ArticleController {
  ...
  @ResponseBody
  public CommonResult<List<Article>> listAll() {
  ...
  @ResponseBody
  public CommonResult<Integer> update(@PathVariable Long id, @RequestBody Article article) {
